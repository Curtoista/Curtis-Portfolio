...
const Footer = () => (
  <Background color="bg-blue-200">
    <Section>
      <CenteredFooterAlt
        logo={<Logo xl />}
        iconList={
          <div className="  md:mr-4 md:flex md:items-center md:space-x-8 flex items-center justify-center space-x-16 spacey-y-12">
            <a
  ...
  9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04
  -.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 
  18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084
  -.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 
  2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665
  -.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 
  1.235-3.22-.135-.303-.54-1.523.105-3.176 0 
  ...
  5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063
  -2.065 2.064 2.064 0 112.063 2.065zm1.782 
  ...
  .774 23.2 0 22.222 0h.003z" />
            ...
            >
              <DocumentTextIcon className="w-10 h-10 text-black hover:text-green-600 transition-colors duration-300" />
            </a>
          </div>
        }
      ></CenteredFooterAlt>
